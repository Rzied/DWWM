...
// $t=new Utilisateurs (["idUtilisateur"=>1,"nomUtilisateur"=>"RJEB","prenomUtilisateur"=>"Zied","passUtilisateur"=>"PASSWORDZ","mail"=>"zied@gmail.com","roleUser"=>"Admin","pseudo"=>"RZied"]);
// echo $t->toString();