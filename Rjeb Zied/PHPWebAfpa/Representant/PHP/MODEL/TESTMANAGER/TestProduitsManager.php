...
// $newObj = new Produits(["nomProduit" => "Clavier", "couleurProduit" => "Orange", "poidsProduit" => "200"]);
...
// $obj->setCouleurProduit("Black");
// ProduitsManager::update($obj);
// $objUpdated = ProduitsManager::findById(2);
// echo "Liste des objets" . "<br>";
// $array = ProduitsManager::getList();
// foreach ($array as $unObj)
// {
...
// $obj = ProduitsManager::findById(7);
