...
--
DROP DATABASE baseproduitsMoi;
CREATE DATABASE IF NOT EXISTS baseproduitsMoi ;
USE baseproduitsMoi;
...
INSERT INTO clients (idClient, nomClient, prenomClient, dateDeNaissance) VALUES(3, 'lecler', 'Pierre', '2002-11-30');
INSERT INTO clients (idClient, nomClient, prenomClient, dateDeNaissance) VALUES(4, 'POIX', 'Sofiane', '2000-10-30');
