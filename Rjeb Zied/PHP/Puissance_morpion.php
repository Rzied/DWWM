    ...
    if ($jeu == "M") {
        ...
        do {
            do //boucle pour verifier si les position existe dans le plateau
            {
                ...
                do // boucle pour la saisie et verifier si la chaine est bien alpha de 1 ou 2 caractères
                {

                    $chaine = readline("$symbole veuillez saisir la colonne de votre pion: ");
...
{
    do {
        $jeu = readline("vous voulez jouer à quoi ? ");
    } while (!strtoupper($jeu) == "M" xor !strtoupper($jeu) == "P");
